...
1. Reliable
2. Created for large teams
3. Will be here in 5 years, 10 probably
4. Large stdlib, less dependency on 3rd party libraries
5. Easy to learn from a PHP background
6. Has all the libraries we need
...
<img
  src={require("!file-loader!./img/heart-hug.svg")}
  style={{ height: "40vh" }}
/>
...
- gqlgen: GraphQL schema-first codegen
